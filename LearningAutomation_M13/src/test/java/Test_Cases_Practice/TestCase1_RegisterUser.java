...
//		6. Enter name and email address
		...
		driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("Shivasms6@gmail.com");
...
//		9. Fill details: Title, Name, Email, Password, Date of birth
		...
		js.executeScript("arguments[0].value='Sean AnSh'", name);
		
		WebElement email=driver.findElement(By.xpath("//input[@id='email']"));
		js.executeScript("arguments[0].value='ansh@gmail.com'", email);
...
//		17. Click 'Delete Account' button
		...
		String deletedAcountText=driver.findElement(By.xpath("//b[text()='Account Deleted!']")).getText();
		System.out.println(deletedAcountText);

		if (actualuText.equalsIgnoreCase(deletedAcountText)) {
			driver.findElement(By.xpath("//b[text()='Account Deleted!']")).click();
			System.out.println("Your acount is deleted succesfully");
		...
		System.out.println("Register user test case has been complted succesfully");
